"""إدارة تصنيفات الأدوات والاستهلاكات."""
...
router = APIRouter(prefix="/admin/consumable-categories", tags=["consumable-categories"])
...
def categories_page(
    ...
    return templates.TemplateResponse(
        "admin_consumable_categories.html",
        {
            "request": request,
            "categories": load_consumable_categories(db),
...
def categories_add(
    ...
    try:
        ...
        return RedirectResponse(
            "/admin/consumable-categories?err=" + quote(str(exc)),
            status_code=302,
        )
    return RedirectResponse("/admin/consumable-categories?saved=1", status_code=302)
