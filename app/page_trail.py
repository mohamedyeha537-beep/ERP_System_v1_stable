...
_RULES: list[tuple[re.Pattern[str], str, str, tuple[TrailItem, ...]]] = [
    ...
    (re.compile(r"^/pos/treasury/transfer$"), "/pos/treasury", "الخزينة", (TrailItem("/pos", "نقطة البيع"),)),
    (re.compile(r"^/pos/treasury$"), "/pos", "نقطة البيع", (TrailItem("/pos/treasury", "الخزينة"),)),
