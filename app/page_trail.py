...
_RULES: list[tuple[re.Pattern[str], str, str, tuple[TrailItem, ...]]] = [
    ...
    (re.compile(r"^/admin/hotel/reports/bookings$"), "/admin/hotel/reports", "تقارير الفندق", (TrailItem("/admin/hotel/reports/bookings", "تأجير الشقق"),)),
    (re.compile(r"^/admin/hotel/reports/breakfast$"), "/admin/hotel/reports", "تقارير الفندق", (TrailItem("/admin/hotel/reports/breakfast", "تكلفة الإفطار"),)),
    ...
    (re.compile(r"^/pos/treasury/transfer$"), "/pos/treasury/banks", "حسابات المصارف", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/receipts$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/hotel-shifts$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/pos-shifts$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/vouchers/in$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/debts$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/banks$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/reports$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/advances$"), "/pos/treasury/custody", "العهد", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/custody/\d+$"), "/pos/treasury/custody", "العهد", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/custody$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/pay$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/admin/treasury-pay-categories$"), "/pos/treasury/pay", "سندات الصرف", (TrailItem("/pos/treasury/desk", "أمين الخزينة"), TrailItem("/admin/treasury-pay-categories", "بنود الصرف"),)),
    (re.compile(r"^/pos/treasury/session$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury/desk$"), "/", "السابق", (TrailItem("/pos/treasury/desk", "أمين الخزينة"),)),
    (re.compile(r"^/pos/treasury$"), "/pos/treasury/desk", "لوحة الخزينة", (TrailItem("/pos/treasury/desk", "أمين الخزينة"), TrailItem("/pos/treasury", "دفتر الخزينة"),)),
